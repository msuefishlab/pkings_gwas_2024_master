...
cat ${root}/input_data/00_Reference_Genome/${chr_name_map} | cut -f1,2 > ${root}/input_data/00_Reference_Genome/input_data/00_Reference_Genome/${chr_name_map}.only.txt
