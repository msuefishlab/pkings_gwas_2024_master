...
#note there is a problem with how tajima's d is being calculated.  there are double values for some intervals, suggesting that the method of breaking up the chromosomes needs to be revisited for this step.
...
```{r}
{tajd_df} %>%
  dplyr::group_by(pop1, pop2, chromosome, window_pos_1, window_pos_2, statistic) %>%
