...
```{r}
paramormyrops_tree_file<-file.path(root,"output_data/04_Phylogeny_And_Admixture/pkings_iqtree_genes_astral_gcf_scf_tree.cf.tree.nex")
fish_data_file<-file.path(root,"input_data/01_Terra/data_model/fish_data_2024a.txt")
treefile<-file.path(root,"input_data/04_Phylogeny_And_Admixture/ssAll_iqtree_timtree.tree")
...
cf_stats_file<-file.path(root,"output_data/04_Phylogeny_And_Admixture/pkings_iqtree_genes_astral_gcf_scf_tree.cf.stat")
...
cf_branch_file<-file.path(root,"output_data/04_Phylogeny_And_Admixture/pkings_iqtree_genes_astral_gcf_scf_tree.cf.branch")
...
```{r,fig.width=8}
plot_name<-file.path(root,'output_data/04_Phylogeny_And_Admixture/paramormyrops_parsimony.svg')
...
```{r, fig.width=8}
plot_name<-file.path(root,'output_data/04_Phylogeny_And_Admixture/paramormyrops_character_map.svg')
svg(plot_name, width=12)  # Adjust width as needed
arctree(ultrametric_rooted_tree,0.4)
tiplabels(pie=to.matrix(newphenos[ultrametric_rooted_tree$tip.label], levels(newphenos)), piecol=cols, cex=0.3)
nodelabels(node=1:ultrametric_rooted_tree$Nnode+Ntip(ultrametric_rooted_tree),
