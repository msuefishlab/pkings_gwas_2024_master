...
echo sbatch --job-name "SPLIT_VCFS" --output ${root}"/output_data/slurm_logs/04_Phylogeny_And_Admixture/phylo_split_gffs_%a.log" -a 0-${gff_file_count} --export=root=${root} ${root}/code/04_Phylogeny_and_Admixture/split_vcf_to_genes.sb
sbatch --job-name "SPLIT_VCFS" --output ${root}"/output_data/slurm_logs/04_Phylogeny_And_Admixture/phylo_split_gffs_%a.log" -a 0-${gff_file_count} --export=root=${root} ${root}/code/04_Phylogeny_and_Admixture/split_vcf_to_genes.sb
