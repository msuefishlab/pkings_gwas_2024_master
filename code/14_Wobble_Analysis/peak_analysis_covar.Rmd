...
params:
  data_path: PKINGS_ALL_WOB_INCLUDED
  output_file: NULL
  MAF_thresh: 0.15
---
...
```{r}
geno_path<-file.path(root,"output_data","14_Wobble_Analysis",params$data_path,paste0(params$data_path,".bin.pos.genos"))
peaks_path<-file.path(root,"output_data","14_Wobble_Analysis",params$data_path,paste0(params$data_path,"_PEAKS.bed"))
logp_path<-file.path(root,"output_data","14_Wobble_Analysis",params$data_path,paste0(params$data_path,"_SNPS_IN_PEAKS_TOP250.txt"))
...
gemma_file<-file.path(root,"output_data","14_Wobble_Analysis",params$data_path,paste0(params$data_path,".conditional.lmm2.assoc.txt"))
minpath<-file.path(root,"output_data","14_Wobble_Analysis",params$data_path,paste0(params$data_path,"_permution"),"min.txt")
ldpath<-file.path(root,"output_data","14_Wobble_Analysis",params$data_path,paste0(params$data_path,"_index_snps.ld.ld"))
peak_data_path<-file.path(root,"output_data","14_Wobble_Analysis",params$data_path)
...
df_norm_w_p <- df_norm %>% left_join(pk.lmm,c("pos"="ps"))

df_norm_w_p %>% filter(log_p>suggestive)


# 1) Row-wise sums per (peak, Phenotype, name)
geno_map <- c("0" = 0, "1" = 1, "2" = 2)

row_sums <- df_norm_w_p %>%
