...
bcftools view -R ${outdir}/${OUTNAME}_snps.txt $snps_only_vcf -O z -o ${outdir}/${OUTNAME}_OUTLIER_SNPs_TOP250.vcf.gz

bcftools query -l ${outdir}/${OUTNAME}_OUTLIER_SNPs_TOP250.vcf.gz | tr "\n" "\t" >${outdir}/${OUTNAME}_header.txt
