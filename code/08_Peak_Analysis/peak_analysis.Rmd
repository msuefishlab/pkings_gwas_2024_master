...
write.tree(ultrametric_rooted_tree,file.path(root,"output_data","08_Peak_Analysis",paste0(params$data_path,".tree")))

ultrametric_rooted_tree <- ape::read.tree(file.path(root,"output_data","08_Peak_Analysis",paste0(params$data_path,".tree")))
...
for (peak.idx in unique(df.bed$peak)){
  ...
  ggsave(file.path("output_data","08_Peak_Analysis",params$data_path,paste0(params$data_path,"_PEAK",peak.idx,"_CHR",chr.idx, ".png")), width = 8.5, height = 17)
