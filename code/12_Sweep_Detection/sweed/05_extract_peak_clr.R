...
## Extract CLR values within GWAS peak regions (SweeD version)
##
## This script reads genome-wide CLR distributions from SweeD and extracts
...
cat("======================================== \n")
cat("Extracting GWAS Peak CLR Values (SweeD)\n")
cat("======================================== \n\n")
...
for (pop in pops) {
  ...
  # SweeD merged files are in sweed/merged/ subdirectory
  clr_file <- file.path(root, "output_data/12_Sweep_Detection/sweed/merged",
...
# Save combined peak CLR values (SweeD output directory)
outdir <- file.path(root, "output_data/12_Sweep_Detection/sweed")
...
cat("========================================\n")
cat("\nNext step: Render analysis notebook with sweed_analysis.Rmd\n")
